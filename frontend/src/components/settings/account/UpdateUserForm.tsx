...
// Version with tabs for better organization
const UpdateProfileTabs = () => {
  ...
  return (
    <Card
      ...
      tabList={[
        { key: "personal", tab: "البيانات الشخصية" },
        { key: "contact", tab: "بيانات الاتصال" },
      ]}
      activeTabKey={activeTab}
      onTabChange={(key) => setActiveTab(key as "personal" | "contact")}
    >
      {activeTab === "personal" && (
        <Form layout="vertical">
          ...
          >
            <Input placeholder="الاسم الكامل" size="large" />
          </Form.Item>
          ...
          >
            <Input placeholder="الرقم القومي" size="large" />
          </Form.Item>
        </Form>
      )}
      ...
      {activeTab === "contact" && (
        <Form layout="vertical">
          ...
          >
            <Input placeholder="رقم الهاتف" size="large" />
          </Form.Item>

          {/* Optional email field if you have it */}
          <Form.Item
          ...
          >
            <Input placeholder="البريد الإلكتروني" size="large" type="email" />
          </Form.Item>
        </Form>
      )}
